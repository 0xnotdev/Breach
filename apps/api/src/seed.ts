...
await store.recordDiscoveryPage("demo", 9_000_001, [{ repoId: 9_000_001, fullName: "fixture/canary", htmlUrl: "https://github.com/fixture/canary", discoveredAt: new Date("2026-08-12T12:00:00.000Z"), priorityScore: 96, candidateState: "WAITING_FOR_COMMIT" }]);
const finding: SanitizedFinding = { findingId: "00000000-0000-4000-8000-000000000001", detectedAt: "2026-08-12T12:00:00.000Z", repository: { id: 9_000_001, fullName: "fixture/canary", url: "https://github.com/fixture/canary" }, revision: { ref: "HEAD", sha: "a".repeat(40) }, category: "secret_exposure", severity: "critical", confidence: .98, secretEvidence: { type: "AWS Secret Access Key", provider: "AWS", path: "credential.txt", line: 1, fingerprint: "f".repeat(64) }, coverage: { ref: `HEAD@${"a".repeat(40)}`, historyScanned: false, scanComplete: true, filesSeen: 1, filesAnalyzed: 1, bytesInspected: 64, skippedBinary: 0, skippedOversize: 0, skippedBudget: 0, treeTruncated: false, languagesModeled: [] }, reviewState: "UNREVIEWED" };
